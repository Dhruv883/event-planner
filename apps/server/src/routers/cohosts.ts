...
// Event-scoped: list cohosts and invites for an event
router.get("/events/:id/cohosts/invites", requireAuth, async (req, res) => {
  try {
...
// Event-scoped: create invite
router.post("/events/:id/cohosts/invite", requireAuth, async (req, res) => {
  try {
    const eventId = req.params.id;
...
// Event-scoped: accept
router.post(
  "/events/:id/cohosts/invites/:inviteId/accept",
  requireAuth,
  async (req, res) => {
    try {
...
// Event-scoped: decline
router.post(
  "/events/:id/cohosts/invites/:inviteId/decline",
  requireAuth,
  async (req, res) => {
    try {
      const { id: eventId, inviteId } = req.params as {
...
// Event-scoped: revoke (host only)
router.post(
  "/events/:id/cohosts/invites/:inviteId/revoke",
  requireAuth,
  async (req, res) => {
    try {
      const { id: eventId, inviteId } = req.params as {
...
// Event-scoped: remove co-host
router.delete("/events/:id/cohosts/:userId", requireAuth, async (req, res) => {
  try {
...
// User-scoped: list invites for authenticated user
router.get("/cohost-invites", requireAuth, async (req, res) => {
  try {
